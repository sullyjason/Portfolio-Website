...
</ul><h2 class="text-2xl font-bold mt-12 mb-6 text-gray-900 border-b border-gray-100 pb-3">Ideation</h2>
<p class="mb-6 leading-relaxed text-gray-700">The original idea revolved around animating a marionette by controlling a series of waves or frequencies through an experimental and highly tactile interface.</p>
...
</ul><p class="mb-6 leading-relaxed text-gray-700">Andy developed a physical version of r/place in 2023 with <a href="https://andykong.org/projects/gridworld/" target="_blank" class="text-blue-600 hover:text-blue-800 underline underline-offset-4 decoration-2 transition-all font-medium">GridWorld</a>, a virtual canvas that was displayed in real time on a physical LED screen. My own ideas came from previous projects such as <a href="project.html?id=010" class="text-blue-600 hover:text-blue-800 underline underline-offset-4 decoration-2 transition-all font-medium">GlowGrid</a> and my work in tactile user interfaces.</p>
