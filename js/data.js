...
<div class="my-12 flex justify-center"><img src="images/projects/puppet-synthesizer/panel_closeup.jpg" alt="Panel closeup" class="max-w-full rounded-2xl shadow-xl border border-gray-100 cursor-zoom-in" loading="lazy" onclick="openLightbox(this.src)" /></div>
...
<div class="my-12 flex justify-center"><img src="images/projects/wearable-sensor-docking-station/render_open.jpg" alt="Photo of final product, enhanced ligthing using AI" class="max-w-full rounded-2xl shadow-xl border border-gray-100 cursor-zoom-in" loading="lazy" onclick="openLightbox(this.src)" /></div>
<h2 class="text-2xl font-bold mt-12 mb-6 text-gray-900 border-b border-gray-100 pb-3">Prototyping</h2>
...
<p class="mb-6 leading-relaxed text-gray-700">The new design was accepted and presented as the new "Wallbo 2.0" design for a submission to CHI 2026.</p>`
    },
    {
      ...
      "collaborators": [{"name": "Vendela H\u00e5konsen", "link": "https://venaur.com/"}, {"name": "Rachel Lin", "link": "https://www.linkedin.com/in/rachel-lin-huiyi/"}, {"name": "Li De"}, {"name": "Leonie Karbownik"}, {"name": "Anja Schl\u00e4ppi"}],
      "links": [{"label": "Transcultural Collaboration Website", "url": "https://www.transculturalcollaboration.com/"}],
...
<div class="my-12 flex justify-center"><img src="images/projects/Again-and-again-and-again/action-shot.jpg" alt="Rachel Lin performing" class="max-w-full rounded-2xl shadow-xl border border-gray-100 cursor-zoom-in" loading="lazy" onclick="openLightbox(this.src)" /></div>`
    ...
    {
      "id": "018",
      "thumbnailUrl": "images/projects/keppler-sunrise/closeup.jpg",
      ...
      "date": "May 2026",
      "slug": "/p/018",
      "skills": ["Installation Design", "Lighting Design", "CAD", "Laser Cutting", "Blender"],
      "collaborators": [{"name": "Sacha Schwarz", "link": "https://sacha-schwarz.ch/"}],
      "links": [],
      "story": `<p class="mb-6 leading-relaxed text-gray-700"><em>Keppler's Sunrise</em> was a light installation meant to evoke the feeling of experiencing a sunrise on a different planet. It was exhibited at Lange Nacht at Toni-Areal in the spring of 2026, in a blacked-out room where visitors could sit down in front of a window and watch daybreak on a world that doesn't exist.</p>
<div class="my-12 flex justify-center"><img src="images/projects/keppler-sunrise/distant.jpg" alt="Visitors watching the window at Lange Nacht" class="max-w-full rounded-2xl shadow-xl border border-gray-100 cursor-zoom-in" loading="lazy" onclick="openLightbox(this.src)" /></div>
<p class="mb-6 leading-relaxed text-gray-700">Sunlight is surprisingly difficult to replicate artificially. It arrives as a parallel beam, casting shadows that hold their shape regardless of distance, and its color shifts continuously as the atmosphere scatters it throughout the day. The experience of standing in sunlight is something we take for granted on Earth, but it is specific to our star and our atmosphere. We wanted to know whether we could recreate the feeling of standing under a different sun on a different world.</p>
<h3 class="text-xl font-bold mt-10 mb-4 text-gray-900">A Planet with Two Suns</h3>
...
<p class="mb-6 leading-relaxed text-gray-700">The plan was to send two collimated beams into the same scattering vessel from slightly offset angles — one matched to a hot blue-white star, the other to a cooler orange companion. The medium should treat each spectrum differently: the blue star's light scattering intensely and flooding the vessel with a deep violet-blue glow, while the orange star's beam cuts cleanly through, barely touched. The color balance in the room would shift into a palette no earthly atmosphere has ever produced.</p>
<div class="my-12 flex justify-center"><img src="images/projects/keppler-sunrise/mirrors.jpg" alt="The two parabolic reflectors, one warm and one blue-white" class="max-w-full rounded-2xl shadow-xl border border-gray-100 cursor-zoom-in" loading="lazy" onclick="openLightbox(this.src)" /></div>
<h3 class="text-xl font-bold mt-10 mb-4 text-gray-900">Collimating the Light</h3>
Each star is a bright film light aimed at a parabolic mirror, made from an upcycled satellite dish covered in reflective vinyl tape. The parabola turns the lamp's conical dispersion into a straight beam, which casts the hard shadows we expect from direct sunlight. We used two dishes of different sizes, one per star. DIY Perks' <a href="https://www.youtube.com/watch?v=6bqBsHSwPgw" target="_blank" class="text-blue-600 hover:text-blue-800 underline underline-offset-4 decoration-2 transition-all font-medium">build of a realistic artificial sun</a> was a useful reference for the optics.
<h3 class="text-xl font-bold mt-10 mb-4 text-gray-900">The Window</h3>
...
<div class="my-12 flex justify-center"><img src="images/projects/keppler-sunrise/screenshot_cad.jpg" alt="CAD assembly of the tank and the laser-cut layout" class="max-w-full rounded-2xl shadow-xl border border-gray-100 cursor-zoom-in" loading="lazy" onclick="openLightbox(this.src)" /></div>
<p class="mb-6 leading-relaxed text-gray-700">The tank had to hold a few millimetres of fluid between two sheets of glass without leaking, so it was modelled in CAD around its gasket, and the frame was drawn as a set of laser-cut parts.</p>
<div class="my-12 flex justify-center"><img src="images/projects/keppler-sunrise/work_in_progress1.jpg" alt="Assembling the octagonal frame in the workshop" class="max-w-full rounded-2xl shadow-xl border border-gray-100 cursor-zoom-in" loading="lazy" onclick="openLightbox(this.src)" /></div>
<h3 class="text-xl font-bold mt-10 mb-4 text-gray-900">Planning the Room</h3>
...
<div class="my-12 flex justify-center"><img src="images/projects/keppler-sunrise/screenshot_blender.jpg" alt="Blender layout of the installation" class="max-w-full rounded-2xl shadow-xl border border-gray-100 cursor-zoom-in" loading="lazy" onclick="openLightbox(this.src)" /></div>
<p class="mb-6 leading-relaxed text-gray-700">We built the installation over a few weeks between March and May 2026, which left little room for rebuilding anything twice. Setting up on site meant getting the two beams to land on the same aperture from a lighting rig assembled around the tank, entirely out of the visitors' view.</p>
<div class="my-12 flex justify-center"><img src="images/projects/keppler-sunrise/behind_the_scenes.jpg" alt="Setting up the lights, dishes and tank behind the window wall" class="max-w-full rounded-2xl shadow-xl border border-gray-100 cursor-zoom-in" loading="lazy" onclick="openLightbox(this.src)" /></div>
<h3 class="text-xl font-bold mt-10 mb-4 text-gray-900">Lange Nacht</h3>
...
<div class="my-12 flex justify-center"><img src="images/projects/keppler-sunrise/closeup2.jpg" alt="Visitors silhouetted against the window" class="max-w-full rounded-2xl shadow-xl border border-gray-100 cursor-zoom-in" loading="lazy" onclick="openLightbox(this.src)" /></div>`
    },
    {
      "id": "7846",
