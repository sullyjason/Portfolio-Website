---
id: 3456 # Use a unique 4 or 5 digit number
status: published # published, unlisted, or draft
company: "ZHdK / Shared Campus"
thumbnailUrl: "images/thumbnail.png" # Relative path to your main thumbnail
...
type: "Arts Production" # Design, Engineering, Research, etc.
date: "March 2026"
slug: "/p/3456" # Match the ID above
skills: 
...
The installation and performance was part of an exhibition called *Hati Hati, It Will Rain Soon*, hosted at Galleri Lorong in Yogyakarta. 27 artists, both from Yogyakarta and international, presented
artistic works offering insights into our collaborative and transcultural working processes, observing and reflecting on the cultural context of Yogyakarta where we had been staying for 3 weeks.

![Rachel Lin performing in Again & Again & Again &](images/closeup-rachel.png)
...
![Planning the installation](images/planning.png)
...
![Sourcing materials in Yogyakarta](images/sourcing.png)
...
![Building the installation](images/installing.png)


### The Program "Transcultural Collaboration"
...
![Rachel Lin performing](images/action-shot.png)